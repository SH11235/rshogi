...
cargo build --release -p tools --no-default-features \
  --features ls-size-768x16x32,ls-ext-threat,threat-profile-same-class
cargo run --release --bin verify_nnue_accumulator -- \
...
cargo build --release -p rshogi-usi --no-default-features \
  --features rshogi-core/ls-arch,rshogi-core/ls-size-768x16x32,rshogi-core/ls-ext-threat,rshogi-core/threat-profile-same-class,rshogi-core/search-no-pass-rules,rshogi-usi/ls-arch,rshogi-usi/ls-ext-threat,rshogi-usi/threat-profile-same-class,rshogi-usi/diagnostics
