...
|----|-------------------|-------------------|------|
| 1536 | 16 | 32 | 従来バリアント (`ls-size-1536x16x32`) |
| 1536 | 32 | 32 | 32x32 バリアント (`ls-size-1536x32x32`) |
| 768 | 16 | 32 | 16x32 バリアント (`ls-size-768x16x32`) |
| 768 | 8 | 32 | 8x32 バリアント (`ls-size-768x8x32`) |
| 512 | 16 | 32 | 16x32 バリアント (`ls-size-512x16x32`) |
