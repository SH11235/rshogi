...
| ft (LS) | `halfka_hm_merged` / `halfka_hm_split` / `halfka_merged` | ✗ | ✓ |
...
# L0=768 系 specific edition は nnue-progress-diff を **含めない** (退行回避)
...
Phase 1 着手時、既存 atomic feature を以下の対応で rename / 分割:
