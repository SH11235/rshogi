...
- **本 ADR の範囲外** (別 ADR / Issue で扱う):
  ...
  - **LayerStack の FT generic 化** (Issue SH11235/rshogi#734): LS network を
    HalfKaHmMerged 専用 hardcode から解放し、5 variant 全対応にする実装。
    本 ADR §「LS FT generic 化」で扱い、当該 Issue で実装完了。
