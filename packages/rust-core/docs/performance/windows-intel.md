...
| 2025-12-22 | 計測条件をmovetime=20000msに変更し本計測実施。NNUE: 406,325 NPS、Material: 248,980 NPS。**ブランチ `nnue_vnni_dpbusd_support` のAVX512-VNNI DPBUSD命令最適化により、Intel環境（Cascade Lake-X）でNNUE推論が高速化**。探索深さも向上（NNUE中盤: 24、終盤: 22） |
