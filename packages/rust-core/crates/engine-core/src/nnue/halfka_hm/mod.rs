...
impl HalfKAStack {
    ...
    pub fn from_network(net: &HalfKANetwork) -> Self {
        match net {
            HalfKANetwork::L256(_) => Self::L256(AccumulatorStackHalfKA_hm::<256>::new()),
            HalfKANetwork::L512(_) => Self::L512(AccumulatorStackHalfKA_hm::<512>::new()),
            HalfKANetwork::L1024(_) => Self::L1024(AccumulatorStackHalfKA_hm::<1024>::new()),
        }
    }
...
mod tests {
    ...
    fn test_halfka_stack_from_network_l1_size() {
        ...
        let stack = HalfKAStack::L256(AccumulatorStackHalfKA_hm::<256>::new());
        assert_eq!(stack.l1_size(), 256);

        let stack = HalfKAStack::L512(AccumulatorStackHalfKA_hm::<512>::new());
        assert_eq!(stack.l1_size(), 512);

        let stack = HalfKAStack::L1024(AccumulatorStackHalfKA_hm::<1024>::new());
    ...
    fn test_push_pop_index_consistency_l256() {
        let mut stack = HalfKAStack::L256(AccumulatorStackHalfKA_hm::<256>::new());
    ...
    fn test_push_pop_index_consistency_l512() {
        let mut stack = HalfKAStack::L512(AccumulatorStackHalfKA_hm::<512>::new());
        let dirty = DirtyPiece::default();
    ...
    fn test_push_pop_index_consistency_l1024() {
        let mut stack = HalfKAStack::L1024(AccumulatorStackHalfKA_hm::<1024>::new());
        let dirty = DirtyPiece::default();
