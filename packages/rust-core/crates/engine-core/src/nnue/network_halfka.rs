...
mod tests {
    ...
    fn test_parse_qa_from_arch() {
        assert_eq!(parse_qa_from_arch("HalfKA_hm^512x2-8-96-qa=255"), Some(255));
        assert_eq!(parse_qa_from_arch("HalfKA_hm^512x2-8-96-qa=127"), Some(127));
        assert_eq!(parse_qa_from_arch("HalfKA_hm^512x2-8-96"), None);
    }
