...
mod tests {
    ...
    fn test_pv_edge_cases() {
        ...
        let move1 = Move::normal(parse_usi_square("7g").unwrap(), parse_usi_square("7f").unwrap(), false);
    ...
    fn test_pv_clear_operations() {
        ...
        // Add some moves
        let move1 = Move::normal(parse_usi_square("7g").unwrap(), parse_usi_square("7f").unwrap(), false);
        let move2 = Move::normal(parse_usi_square("6c").unwrap(), parse_usi_square("6d").unwrap(), false);
    ...
    fn test_pv_consistency_after_updates() {
        ...
        let move1 = Move::normal(parse_usi_square("7g").unwrap(), parse_usi_square("7f").unwrap(), false);
        let move2 = Move::normal(parse_usi_square("6c").unwrap(), parse_usi_square("6d").unwrap(), false);
        let move3 = Move::normal(parse_usi_square("2g").unwrap(), parse_usi_square("2f").unwrap(), false);
