//! SimpleParallelSearcher benchmarks using Criterion
//!
            ...
            |b, &threads| {
                b.iter_custom(|iters| {
                    ...
                    for _ in 0..iters {
                        ...
                        let limits = SearchLimitsBuilder::default()
                            .time_control(TimeControl::FixedTime { ms_per_move: fixed_ms })
            ...
            |b, &threads| {
                b.iter_custom(|iters| {
                    ...
                    for _ in 0..iters {
                        ...
                        let limits = SearchLimitsBuilder::default()
                            .time_control(TimeControl::FixedTime { ms_per_move: target_ms })
                            .build();
