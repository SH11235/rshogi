...
impl<const L1: usize> FeatureTransformerHalfKA<L1> {
    ...
    pub(crate) fn share_weights(&mut self) {
        super::shared_weights::try_share(&mut self.weights, "FT weights (HalfKA)");
    }
...
> NetworkHalfKA<L1, FT_OUT, L1_INPUT, L2, L3, A>
{
    ...
    pub fn read<R: Read + Seek>(reader: &mut R) -> io::Result<Self> {
        ...
        let mut feature_transformer = FeatureTransformerHalfKA::read(reader)?;
...
mod tests {
    ...
    fn test_type_aliases() {
        ...
        fn _check_halfka_512_crelu(_: HalfKA512CReLU) {}
        fn _check_halfka_1024_crelu(_: HalfKA1024CReLU) {}
    }
}
