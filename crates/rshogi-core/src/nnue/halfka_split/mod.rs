...
mod tests {
    ...
    fn stack_lifecycle_for_each_size() {
        for (l1, mut stack) in [
            (256, HalfKaSplitStack::L256(AccumulatorStackHalfKaSplit::<256>::new())),
            (512, HalfKaSplitStack::L512(AccumulatorStackHalfKaSplit::<512>::new())),
            (768, HalfKaSplitStack::L768(AccumulatorStackHalfKaSplit::<768>::new())),
            (1024, HalfKaSplitStack::L1024(AccumulatorStackHalfKaSplit::<1024>::new())),
        ] {
