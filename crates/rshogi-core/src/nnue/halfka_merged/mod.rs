...
mod tests {
    ...
    fn stack_lifecycle_for_each_size() {
        for (l1, mut stack) in [
            (256, HalfKaMergedStack::L256(AccumulatorStackHalfKaMerged::<256>::new())),
            (512, HalfKaMergedStack::L512(AccumulatorStackHalfKaMerged::<512>::new())),
            (768, HalfKaMergedStack::L768(AccumulatorStackHalfKaMerged::<768>::new())),
            (1024, HalfKaMergedStack::L1024(AccumulatorStackHalfKaMerged::<1024>::new())),
        ] {
