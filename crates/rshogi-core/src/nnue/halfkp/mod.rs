...
mod tests {
    ...
    fn stack_lifecycle_for_each_size() {
        for (l1, mut stack) in [
            (256, HalfKPStack::L256(AccumulatorStackHalfKP::<256>::new())),
            (512, HalfKPStack::L512(AccumulatorStackHalfKP::<512>::new())),
            (768, HalfKPStack::L768(AccumulatorStackHalfKP::<768>::new())),
            (1024, HalfKPStack::L1024(AccumulatorStackHalfKP::<1024>::new())),
        ] {
