...
impl Default for SearchTuneParams {
    fn default() -> Self {
        Self {
            ...
            futility_margin_base: 89,
            futility_margin_tt_bonus: 27,
            futility_improving_scale: 2052,
            futility_opponent_worsening_scale: 1300,
            futility_correction_div: 164_253,
            razoring_margin_base: 494,
            razoring_margin_depth2_coeff: 279,
            nmp_margin_depth_mult: 17,
            nmp_margin_offset: -329,
